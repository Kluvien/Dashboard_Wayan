...
<section class="anggota-activity-form" aria-labelledby="anggota-activity-create-title">
    <header class="anggota-activity-form__header">
        <div>
            ...
            <h1 id="anggota-activity-create-title" class="anggota-activity-form__title">Tambah Aktivitas KM</h1>
    ...
    @else
    <form action="/anggota/aktivitas-km" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div class="col-md-6">
                    ...
                    <div class="position-relative field-with-icon">
                        ...
                        <input
                            ...
                            value="{{ old('judul_aktivitas') }}" placeholder="Contoh: Publikasi jurnal internasional bereputasi"
                            required>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="position-relative field-with-icon">
                        ...
                        <select name="status_progress" id="status_progress" class="form-select interactive-select" required>
                            <option value="On Progress" {{ old('status_progress', 'On Progress') === 'On Progress' ? 'selected' : '' }}>
                                Sedang Berjalan
                            </option>
                            <option value="Submitted" {{ old('status_progress') === 'Submitted' ? 'selected' : '' }}>
                                Ajukan Verifikasi
                            </option>
                        </select>
                    </div>
