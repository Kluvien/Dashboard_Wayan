...
<style>
    ...
    .ketualab-profile__description { margin: 7px 0 0; color: #64748B; font-size: 13px; }
    .ketualab-profile__back { flex: 0 0 auto; padding: 7px 13px; border-color: #CBD5E1; border-radius: 8px; color: #334155; font-size: 13px; font-weight: 700; }
    ...
    .ketualab-profile__value { color: #0F172A; font-size: 14px; font-weight: 600; overflow-wrap: anywhere; }
