...
@section('title', 'Detail KM Anggota Lab')
...
<div class="card mb-4">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-3">
        ...
        <a href="/ketualab/monitoring-anggota?tahun={{ $tahun }}" class="btn btn-secondary">
            Kembali
        </a>
    </div>
                        ...
                        <td style="min-width: 160px;">
                            <div class="progress-soft mb-1">
                                <div
                                    ...
                                    style="width: {{ min($item['progress'] ?? 0, 100) }}%;">
                                </div>
                            </div>

                            <div class="small text-muted">
                                {{ min($item['progress'] ?? 0, 100) }}%
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            @if(!empty($item->bukti_pdf_path) || !empty($item->bukti_file_path))
                                <a href="/bukti-km/{{ $item->id_aktivitas }}/download" class="btn btn-primary btn-sm">
