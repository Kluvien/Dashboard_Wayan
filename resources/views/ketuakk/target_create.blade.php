...
<div class="card">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        <div>
            <h4 class="fw-bold mb-1">Form Tambah Target KM</h4>
            <p class="text-muted mb-0">
                Tambahkan target berdasarkan tahun, kategori, sub kategori, dan pembagian per triwulan.
            </p>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                ...
                <select name="kategori_km" id="kategoriKm" class="form-select" required>
                    ...
                    <option value="{{ $kategori }}" {{ old('kategori_km') == $kategori ? 'selected' : '' }}>
                        {{ $kategori }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="col-md-12">
                <div class="alert alert-info mb-0">
                    Total Target:
                    <strong><span id="totalTargetPreview">0</span></strong>
                </div>
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const oldKategori = @json(old('kategori_km'));
        const oldSubKategori = @json(old('indikator'));
        ...
        renderSubKategori(oldKategori || kategoriSelect.value, oldSubKategori);
        updateTotal();
    });
</script>
@endsection