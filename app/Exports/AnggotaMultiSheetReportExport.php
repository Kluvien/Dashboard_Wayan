...
class AnggotaMultiSheetReportExport implements WithMultipleSheets
{
    ...
    {
        return array_map(
            fn (array $sheet) => new AnggotaReportArraySheet(
...
class AnggotaReportArraySheet implements FromArray, WithHeadings, WithTitle, WithStyles, ShouldAutoSize
{
