...
class KetuaLabMultiSheetReportExport implements WithMultipleSheets
{
    ...
    {
        return array_map(
            fn (array $sheet) => new KetuaLabReportArraySheet(
                $sheet['title'],
                $sheet['headings'],
                $sheet['rows']
            ),
...
class KetuaLabReportArraySheet implements FromArray, WithHeadings, WithTitle, WithStyles, ShouldAutoSize
{
